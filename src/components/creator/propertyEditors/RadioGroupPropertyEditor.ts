...
/**
 * Radio Group Property Editor
 * Handles radio group element properties
 */
export class RadioGroupPropertyEditor {
  ...
  /**
   * Render radio group-specific properties
   */
    ...
    return `
      <div class="space-y-4">
        <div>
          ...
          <p class="mt-1 text-xs text-gray-500">Options for the radio group</p>
        </div>
